...
public class CalculatorTest_Old {
    ...
    private static void add(calculator.Calculator cal) {
        System.out.println(cal.add(3,4));
    }

    private static void subtract(calculator.Calculator cal) {
        System.out.println(cal.subtract(5,4));
    }

    private static void multiply(calculator.Calculator cal) {
        System.out.println(cal.multiply(2,6));
    }

    private static void divide(calculator.Calculator cal) {
